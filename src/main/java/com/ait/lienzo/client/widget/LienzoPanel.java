...
public class LienzoPanel extends FocusPanel implements RequiresResize, ProvidesResize
{
    ...
    public void onResize()
    {
        if (m_flex)
        {
            if (getParent() != null)
            {
                final int wide = getParent().getOffsetWidth();

                final int high = getParent().getOffsetHeight();
    ...
    public LienzoPanel setDragMouseButtons(final DragMouseControl controls)
    {

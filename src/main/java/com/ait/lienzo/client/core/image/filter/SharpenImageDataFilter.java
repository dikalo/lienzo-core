...
public class SharpenImageDataFilter extends AbstractConvolveImageDataFilter<SharpenImageDataFilter>
{
    ...
    public SharpenImageDataFilter(final double... matrix)
    {
        super(ImageFilterType.SharpenImageDataFilterType, matrix);
    }

    public SharpenImageDataFilter(final SharpenType matrix)
    {
        this(matrix.getMatrix());
    }

    protected SharpenImageDataFilter(final JSONObject node, final ValidationContext ctx) throws ValidationException
    {
    ...
    public static enum SharpenType
    {
        ...
        private SharpenType(final double... matrix)
        {
            m_matrix = matrix;
        }
        ...
        {
            final double copy[] = new double[m_matrix.length];
    ...
    public static class SharpenImageDataFilterFactory extends ConvolveImageDataFilterFactory<SharpenImageDataFilter>
    {
        ...
        @Override
        public SharpenImageDataFilter create(final JSONObject node, final ValidationContext ctx) throws ValidationException
        {

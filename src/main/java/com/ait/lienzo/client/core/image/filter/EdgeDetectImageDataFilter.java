...
public class EdgeDetectImageDataFilter extends AbstractImageDataFilter<EdgeDetectImageDataFilter>
{
    ...
    protected EdgeDetectImageDataFilter(final JSONObject node, final ValidationContext ctx) throws ValidationException
    {
    ...
    public static class EdgeDetectImageDataFilterFactory extends ImageDataFilterFactory<EdgeDetectImageDataFilter>
    {
        ...
        @Override
        public EdgeDetectImageDataFilter create(final JSONObject node, final ValidationContext ctx) throws ValidationException
        {

...
public class TextBoundsAndLineBreaksWrap extends TextBoundsWrap
{
    ...
    public TextBoundsAndLineBreaksWrap(final Text text, final BoundingBox wrapBoundaries)
    {
        super(text, wrapBoundaries);
    }

    public TextBoundsAndLineBreaksWrap(final Supplier<String> textSupplier, final Supplier<Double> fontSizeSupplier, final Supplier<String> fontStyleSupplier, final Supplier<String> fontFamilySupplier, final Supplier<TextUnit> textUnitSupplier, final Supplier<TextBaseLine> textBaseLineSupplier, final Supplier<TextAlign> textAlignSupplier, final BoundingBox wrapBoundaries)
    {
        super(textSupplier, fontSizeSupplier, fontStyleSupplier, fontFamilySupplier, textUnitSupplier, textBaseLineSupplier, textAlignSupplier, wrapBoundaries);
    }

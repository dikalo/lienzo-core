...
public class SolarizeImageDataFilter extends AbstractTableImageDataFilter<SolarizeImageDataFilter>
{
    ...
    protected SolarizeImageDataFilter(final JSONObject node, final ValidationContext ctx) throws ValidationException
    {
    ...
    public static class SolarizeImageDataFilterFactory extends TableImageDataFilterFactory<SolarizeImageDataFilter>
    {
        ...
        @Override
        public SolarizeImageDataFilter create(final JSONObject node, final ValidationContext ctx) throws ValidationException
        {

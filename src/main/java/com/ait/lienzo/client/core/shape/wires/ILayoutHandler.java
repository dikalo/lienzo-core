...
public interface ILayoutHandler
{
    ...
    public void add(WiresShape shape, WiresContainer container, Point2D mouseRelativeLoc);

    public void remove(WiresShape shape, WiresContainer container);

    public void requestLayout(WiresContainer container);

    public void layout(WiresContainer container);

    static class DefaultLayoutHandler implements ILayoutHandler
    {
        @Override
        ...
        @Override
        public void remove(final WiresShape shape, final WiresContainer container)
        {

 ...
 *     <li>m_nodeDragEvent = the drag event on the node.</li>
 * </ul>
 */
...
{
    private final AbstractNodeDragEvent<?> m_nodeDragEvent;

    protected AbstractWiresDragEvent(final WiresContainer shape, final AbstractNodeDragEvent<?> nodeDragEvent)
    {
        super(shape);

        m_nodeDragEvent = nodeDragEvent;
    }

    @Override
    public int getX()
    {
        return m_nodeDragEvent.getX();
    }

    @Override
    public int getY()
    {
        return m_nodeDragEvent.getY();
    }

    public AbstractNodeDragEvent<?> getNodeDragEvent()
    {
        return m_nodeDragEvent;
    }
}

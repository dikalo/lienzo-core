...
public class TextLineBreakWrap extends TextNoWrap
{
    ...
    public TextLineBreakWrap(final Supplier<String> textSupplier, final Supplier<Double> fontSizeSupplier, final Supplier<String> fontStyleSupplier, final Supplier<String> fontFamilySupplier, final Supplier<TextUnit> textUnitSupplier, final Supplier<TextBaseLine> textBaseLineSupplier, final Supplier<TextAlign> textAlignSupplier)
    {
    ...
    public BoundingBox getBoundingBox()
    {
        ...
        {
            final double w = getBoundingBoxForString(line).getWidth();

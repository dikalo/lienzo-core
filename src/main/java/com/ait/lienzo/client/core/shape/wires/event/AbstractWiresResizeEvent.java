...
public abstract class AbstractWiresResizeEvent<H extends WiresEventHandler> extends AbstractWiresEvent<WiresShape, H> implements INodeXYEvent
{
    ...
    protected AbstractWiresResizeEvent(final WiresShape shape, final AbstractNodeDragEvent<?> nodeDragEvent, final int x, final int y, final double width, final double height)
    {
        super(shape);

...
public class ExposureImageDataFilter extends AbstractValueTableImageDataFilter<ExposureImageDataFilter>
{
    ...
    public ExposureImageDataFilter(final double value)
    {
        super(ImageFilterType.ExposureImageDataFilterType, value);
    }

    protected ExposureImageDataFilter(final JSONObject node, final ValidationContext ctx) throws ValidationException
    {
    ...
    public static class ExposureImageDataFilterFactory extends ValueTableImageDataFilterFactory<ExposureImageDataFilter>
    {
        ...
        @Override
        public ExposureImageDataFilter create(final JSONObject node, final ValidationContext ctx) throws ValidationException
        {

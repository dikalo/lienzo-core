...
{
    public StackBlurImageDataFilter(final int value)
    {
    ...
    protected StackBlurImageDataFilter(final JSONObject node, final ValidationContext ctx) throws ValidationException
    {
    ...
    public static class StackBlurImageDataFilterFactory extends ValueImageDataFilterFactory<StackBlurImageDataFilter>
    {
        ...
        @Override
        public StackBlurImageDataFilter create(final JSONObject node, final ValidationContext ctx) throws ValidationException
        {

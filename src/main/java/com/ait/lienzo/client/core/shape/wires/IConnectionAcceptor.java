...
public interface IConnectionAcceptor
{
    ...
    public static class DefaultConnectionAcceptor implements IConnectionAcceptor
    {
        ...
        @Override
        public boolean tailConnectionAllowed(final WiresConnection connection, final WiresShape shape)
        {
            return m_defaultValue;
        }

        @Override
        public boolean headConnectionAllowed(final WiresConnection connection, final WiresShape shape)
        {
            return m_defaultValue;
        }

        @Override
        public boolean acceptHead(final WiresConnection connection, final WiresMagnet magnet)
        {
            return m_defaultValue;
        }

        @Override
        public boolean acceptTail(final WiresConnection connection, final WiresMagnet magnet)
        {
            return m_defaultValue;
        }
    }

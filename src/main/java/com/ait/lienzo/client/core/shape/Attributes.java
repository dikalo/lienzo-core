...
public class Attributes
{
    ...
    {
        final JsArray<JavaScriptObject> points = getArrayOfJSO(Attribute.CONTROL_POINTS.getProperty());
    ...
    {
        final FilterConvolveMatrix mjso = FilterConvolveMatrix.make().cast();

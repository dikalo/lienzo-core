...
public class PosterizeImageDataFilter extends AbstractValueTableImageDataFilter<PosterizeImageDataFilter>
{
    ...
    public PosterizeImageDataFilter(final double value)
    {
        super(ImageFilterType.PosterizeImageDataFilterType, value);
    }

    protected PosterizeImageDataFilter(final JSONObject node, final ValidationContext ctx) throws ValidationException
    {
    ...
    public static class PosterizeImageDataFilterFactory extends ValueTableImageDataFilterFactory<PosterizeImageDataFilter>
    {
        ...
        @Override
        public PosterizeImageDataFilter create(final JSONObject node, final ValidationContext ctx) throws ValidationException
        {
